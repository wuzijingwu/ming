...
public class Notification1 extends Activity {
	...
	private void init() {
		...
		pd = PendingIntent.getActivity(Notification1.this, 0, intent, 0);
	}
	...
	OnClickListener onclick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.le10bt01:
				...
				// 第四个参数：点击该通知时执行页面跳转
				baseNF.setLatestEventInfo(Notification1.this, "Title01",
						"Content01", pd);
			...
			case R.id.le10bt02:
				...
				baseNF.setLatestEventInfo(Notification1.this, "Title02",
						"Content02", pd);
				nm.notify(Notification_ID_BASE, baseNF);
				break;
			...
			case R.id.le10bt04:
				...
				mediaNF.setLatestEventInfo(Notification1.this, "Title03",
						"Content03", pd);
