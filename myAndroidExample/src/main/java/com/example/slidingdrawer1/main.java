...
import com.example.slidingdrawer1.Panel.PanelClosedEvent;
import com.example.slidingdrawer1.Panel.PanelOpenedEvent;
...
public class main extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.slidingdrawermain);
		...
		for (int i = 0; i < 100; i++) {
			...
			map.put("ItemImage", R.drawable.tu5503_29);
